...
This is the code for the frontend of [ChatApp](https://github.com/anonymous123-code/chatApp). The backend address can be configured by setting the VITE_APIROOT environment variable(eg. http://localhost:8000/)
